  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="w-[160px] h-[160px] sm:w-[200px] sm:h-[200px] rounded-full overflow-hidden border-[3px] border-[hsl(var(--splash-glow)/0.6)] shadow-[0_0_40px_hsl(var(--splash-glow)/0.3)] bg-background"
          style={{
