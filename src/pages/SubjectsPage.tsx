        ...
        >
          {cls.subjects.map((subject) => (
            <button
              ...
              className="group bg-card border border-border rounded-3xl p-6 flex flex-col items-center gap-4 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer relative overflow-hidden"
            >
              <SubjectBadge subjectId={subject.id} size="md" className="group-hover:scale-110 transition-transform duration-300" />
